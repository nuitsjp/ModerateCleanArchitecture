...
namespace AdventureWorks.Repository
{
    public class SalesOrderDetailRepository : ISalesOrderDetailRepository
    {
        ...
        public async Task<SalesOrderDetail?> GetSalesOrderDetailAsync(SalesOrderDetailKey key)
        {
...
",
                new
                {
                    SalesOrderId = key.GetSalesOrderKey(),
                    SalesOrderDetailId = key.GetSalesOrderDetailId()
                });
